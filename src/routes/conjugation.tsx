...
import { generateDrillsAction, recordAnswerAction, completeSessionAction, unlockRuleAction, getUnlockProgressAction } from "~/lib/conjugation-actions";
...
export default function ConjugationPage() {
  ...
  const handleAnswer = async (drillId: string, answer: string, isCorrect: boolean, timeSpent: number) => {
    try {
      const result = await recordAnswerAction(MOCK_USER_ID, drillId, answer, isCorrect, timeSpent);
      ...
      if (result.unlockResult) {
        ...
        try {
          ...
          console.error('Error generating new drills for unlocked rule:', error);
            ...
            <div class="max-w-2xl mx-auto text-center bg-white rounded-lg shadow p-8">
              ...
              <div class="space-y-4">
                ...
                <button
                  ...
                  class="bg-green-500 text-white px-8 py-3 rounded-lg text-lg hover:bg-green-600 transition-colors"
                >
              ...
              <p class="text-sm text-gray-500 mt-4">
                "Continue Practice" resumes any unfinished session, "Start Fresh Practice" begins with new drills
              </p>
              
              <Show when={userProgress() && userProgress()!.length > 0}>
                <div class="mt-8 pt-6 border-t">
                  <h3 class="text-lg font-semibold mb-4">Your Progress Summary</h3>
                  <p class="text-xs text-gray-500 mb-3">Overall accuracy across all attempts</p>
              ...
              <div class="flex items-center gap-2">
                ...
                <div>
                  ...
                  <div class="text-xs opacity-90">
                    Achieved {unlockNotification()!.accuracy}% accuracy on last 20 exercises
                  </div>
                </div>
                <button
          ...
          <Show when={currentSession() && userProgress()}>
            ...
            <Show when={sessionCompleted()}>
              <div class="max-w-2xl mx-auto text-center bg-white rounded-lg shadow p-8">
                ...
                <h2 class="text-2xl font-semibold mb-4">Practice Session Ended</h2>
                <p class="text-gray-600 mb-6">
